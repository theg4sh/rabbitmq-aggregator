...
bool AmqpResolver::isValid() { return this->valid; }

std::string AmqpResolver::protocol() const { return this->_protocol; }

std::string AmqpResolver::host() const { return this->_host; }
std::string AmqpResolver::user() const { return this->_user; }
std::string AmqpResolver::pass() const { return this->_pass; }
int         AmqpResolver::port() const { return this->_port; }

std::string AmqpResolver::vhost() const { return this->_vhost; }
